    ...
    ISPiDeviceFactory
{
    ...
    private readonly ConcurrentDictionary<Type, PiTopPlate> _plates = new();
    private readonly ConcurrentDictionary<int, I2cDevice> _i2cDevices = new();
    private readonly ConcurrentDictionary<SpiConnectionSettings, SpiDevice> _spiDevices = new();
    ...
    private readonly Dictionary<Type, object> _deviceFactories = new();

    private const int I2CBusId = 1;
    public PiTopButton UpButton { get; } = new();
    public PiTopButton DownButton { get; } = new();
    public PiTopButton SelectButton { get; } = new();
    public PiTopButton CancelButton { get; } = new();
    ...
    public IEnumerable<PiTopPlate> ConnectedPlates => _plates.Values;
